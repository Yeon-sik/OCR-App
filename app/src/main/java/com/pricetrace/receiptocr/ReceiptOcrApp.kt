...
fun ReceiptOcrApp(
    ...
    ReceiptOcrContent(
        ...
        onCanonicalBundleRevisionRetry = viewModel::retryCanonicalBundleRevision,
        onCanonicalReviewMerchantNameChanged = viewModel::updateCanonicalMerchantName,
        onCanonicalReviewFieldChanged = viewModel::updateCanonicalField,
        onCanonicalReviewLineDescriptionChanged = viewModel::updateCanonicalLineDescription,
        onCanonicalReviewLineTypeChanged = viewModel::updateCanonicalLineType,
        onCanonicalReviewFoodServiceRoleChanged = viewModel::updateCanonicalFoodServiceRole,
        onCanonicalReviewOptionParentChanged = viewModel::updateCanonicalFoodServiceOptionParent,
        onCanonicalReviewEventChanged = viewModel::setCanonicalReviewEvent,
        onCanonicalReviewUndo = viewModel::undoCanonicalStructuredEdit,
        onCanonicalReviewRedo = viewModel::redoCanonicalStructuredEdit,
        ...
        canonicalNutritionArtifacts = uiState.canonicalNutritionArtifacts,
        canonicalNutritionVerifiedCount = uiState.canonicalNutritionVerifiedCount,
        canonicalNutritionVerifiedKeys = uiState.canonicalNutritionVerifiedKeys,
        canonicalConsumptionArtifacts = uiState.canonicalConsumptionArtifacts,
        canonicalConsumptionVerifiedCount = uiState.canonicalConsumptionVerifiedCount,
        isSubmittingConsumption = uiState.isConsumptionVerifying,
        onShowConsumptionReview = viewModel::showConsumptionReview,
        onConsumptionConsumedAtChanged = viewModel::updateConsumptionConsumedAt,
        onConsumptionItemAmountChanged = viewModel::updateConsumptionItemAmount,
        onConsumptionItemUnitChanged = viewModel::updateConsumptionItemUnit,
        onConsumptionItemAmountStatusChanged = viewModel::updateConsumptionItemAmountStatus,
        onConfirmConsumption = viewModel::confirmConsumptionReview,
        nutritionSignedInEmail = uiState.nutritionSignedInEmail,
        isSubmittingCanonicalNutrition = uiState.isNutritionPublishing,
        onSubmitCanonicalNutrition = viewModel::submitCanonicalFitnessNutrition,
        onShowCanonicalNutritionReview = viewModel::showCanonicalNutritionReview,
        onShowProductCandidateReview = viewModel::showProductCandidateReview,
        onConfirmCanonicalNutritionReview = viewModel::confirmCanonicalNutritionReview,
        onConfirmCanonicalNutritionArtifact = viewModel::confirmCanonicalNutritionArtifact,
        ...
        onSubmitCanonicalPriceTrace = viewModel::submitCanonicalPriceTrace,
        onSubmitAllReadyCanonicalProjections = viewModel::submitAllReadyCanonicalProjections,
        merchantCandidate = uiState.merchantCandidate,
        merchantCandidateVerified = uiState.merchantCandidateVerified,
        isSubmittingMerchantCandidate = uiState.isSubmittingMerchantCandidate,
        merchantCandidateId = uiState.merchantCandidateId,
        merchantCandidateLastError = uiState.merchantCandidateLastError,
        onConfirmMerchantCandidate = viewModel::confirmMerchantCandidate,
        onSubmitMerchantCandidate = viewModel::submitMerchantCandidate,
        productCandidates = uiState.productCandidates,
        productCandidateVerifiedKeys = uiState.productCandidateVerifiedKeys,
        isSubmittingProductCandidates = uiState.isSubmittingProductCandidates,
        productCandidateId = uiState.productCandidateId,
        productCandidateLastError = uiState.productCandidateLastError,
        onConfirmProductCandidates = viewModel::confirmProductCandidates,
        onSubmitProductCandidates = viewModel::submitProductCandidates,
